...
using the topdesk command-line interface.
...
class APLProcessor:
    ...
    def _validate_authentication(self):
        ...
        if self.use_api_directly:
            ...
            if not self._test_cli_connection():
                raise ConnectionError("Failed to authenticate with topdesk command")
    ...
    def _test_cli_connection(self) -> bool:
        ...
        try:
            ...
            if result.returncode == 0:
                self.logger.info("Successfully authenticated with topdesk command")
                return True
            else:
